...
from typing import Any, Callable, Dict, List, Literal, Optional, Union, _GenericAlias
...
if sys.version_info >= (3, 10):
    ...
    VersionedUnionType = Union[builtin_types.UnionType, _GenericAlias]
    _UNION_TYPES = (typing.Union, builtin_types.UnionType)
else:
    # Supports only Union[t1, t2]
    VersionedUnionType = _GenericAlias
...
class ExecutableCode(_common.BaseModel):
    ...
    code: Optional[str] = Field(default=None, description="""Required. The code to be executed.""")
...
class FileData(_common.BaseModel):
    ...
    mime_type: Optional[str] = Field(
        default=None, description="""Required. The IANA standard MIME type of the source data."""
    )
...
class Part(_common.BaseModel):
    ...
    thought: Optional[bool] = Field(
        default=None, description="""Indicates if the part is thought from the model."""
    )
    code_execution_result: Optional[CodeExecutionResult] = Field(
        default=None, description="""Optional. Result of executing the [ExecutableCode]."""
    )
    executable_code: Optional[ExecutableCode] = Field(
        default=None,
        description="""Optional. Code generated by the model that is meant to be executed.""",
    )
    file_data: Optional[FileData] = Field(default=None, description="""Optional. URI based data.""")
    ...
    text: Optional[str] = Field(default=None, description="""Optional. Text part (can be code).""")
    ...
    def from_bytes(cls, *, data: bytes, mime_type: str) -> "Part":
        inline_data = Blob(data=data, mime_type=mime_type)
    ...
    def from_video_metadata(cls, *, start_offset: str, end_offset: str) -> "Part":
        video_metadata = VideoMetadata(end_offset=end_offset, start_offset=start_offset)
...
class HttpOptions(_common.BaseModel):
    ...
    base_url: Optional[str] = Field(
        default=None, description="""The base URL for the AI platform service endpoint."""
    )
    api_version: Optional[str] = Field(
        default=None, description="""Specifies the version of the API to use."""
    )
    headers: Optional[Dict[str, str]] = Field(
        default=None, description="""Additional HTTP headers to be sent with the request."""
    )
...
class Schema(_common.BaseModel):
    ...
    min_items: Optional[int] = Field(
        default=None, description="""Optional. Minimum number of the elements for Type.ARRAY."""
    )
    ...
    max_length: Optional[int] = Field(
        default=None, description="""Optional. Maximum length of the Type.STRING"""
    )
    ...
    min_properties: Optional[int] = Field(
        default=None, description="""Optional. Minimum number of the properties for Type.OBJECT."""
    )
    max_items: Optional[int] = Field(
        default=None, description="""Optional. Maximum number of the elements for Type.ARRAY."""
    )
    maximum: Optional[float] = Field(
        default=None, description="""Optional. Maximum value of the Type.INTEGER and Type.NUMBER"""
    )
    nullable: Optional[bool] = Field(
        default=None, description="""Optional. Indicates if the value may be null."""
    )
    max_properties: Optional[int] = Field(
        default=None, description="""Optional. Maximum number of the properties for Type.OBJECT."""
    )
    ...
    required: Optional[List[str]] = Field(
        default=None, description="""Optional. Required properties of Type.OBJECT."""
    )
...
class FunctionDeclaration(_common.BaseModel):
    ...
    def from_callable_with_api_option(
        ...
        declaration = FunctionDeclaration(name=callable.__name__, description=callable.__doc__)
        if parameters_properties:
            declaration.parameters = Schema(type="OBJECT", properties=parameters_properties)
        ...
        declaration.response = _automatic_function_calling_util._parse_schema_from_parameter(
            api_option,
            inspect.Parameter(
                "return_value",
                inspect.Parameter.POSITIONAL_OR_KEYWORD,
    ...
    def from_callable(cls, *, client, callable: Callable) -> "FunctionDeclaration":
        ...
        if client.vertexai:
            return cls.from_callable_with_api_option(callable=callable, api_option="VERTEX_AI")
        else:
            return cls.from_callable_with_api_option(callable=callable, api_option="GEMINI_API")
...
class DynamicRetrievalConfig(_common.BaseModel):
    ...
    mode: Optional[DynamicRetrievalConfigMode] = Field(
        default=None, description="""The mode of the predictor to be used in dynamic retrieval."""
    )
...
VertexRagStoreRagResourceOrDict = Union[VertexRagStoreRagResource, VertexRagStoreRagResourceDict]
...
class VertexRagStore(_common.BaseModel):
    ...
    rag_corpora: Optional[List[str]] = Field(
        default=None, description="""Optional. Deprecated. Please use rag_resources instead."""
    )
...
class Retrieval(_common.BaseModel):
    ...
    disable_attribution: Optional[bool] = Field(
        default=None, description="""Optional. Deprecated. This option is no longer supported."""
    )
    vertex_ai_search: Optional[VertexAISearch] = Field(
        default=None, description="""Set to use data source powered by Vertex AI Search."""
    )
...
class Tool(_common.BaseModel):
    ...
    function_declarations: Optional[List[FunctionDeclaration]] = Field(
        default=None, description="""List of function declarations that the tool supports."""
    )
...
class File(_common.BaseModel):
    ...
    create_time: Optional[datetime.datetime] = Field(
        default=None, description="""Output only. The timestamp of when the `File` was created."""
    )
    ...
    sha256_hash: Optional[str] = Field(
        default=None, description="""Output only. SHA-256 hash of the uploaded bytes."""
    )
    ...
    error: Optional[FileStatus] = Field(
        default=None, description="""Output only. Error status if File processing failed."""
    )
...
SchemaUnion = Union[dict, type, Schema, _GenericAlias, VersionedUnionType]
...
class Citation(_common.BaseModel):
    ...
    publication_date: Optional[GoogleTypeDate] = Field(
        default=None, description="""Output only. Publication date of the attribution."""
    )
    ...
    uri: Optional[str] = Field(
        default=None, description="""Output only. Url reference of the attribution."""
    )
...
class GroundingSupport(_common.BaseModel):
    ...
    segment: Optional[Segment] = Field(
        default=None, description="""Segment of the content this support belongs to."""
    )
...
class SearchEntryPoint(_common.BaseModel):
    ...
    sdk_blob: Optional[bytes] = Field(
        default=None, description="""Optional. Base64 encoded JSON representing array of tuple."""
    )
...
class GroundingMetadata(_common.BaseModel):
    ...
    retrieval_queries: Optional[List[str]] = Field(
        default=None, description="""Optional. Queries executed by the retrieval tools."""
    )
...
class LogprobsResultTopCandidates(_common.BaseModel):
    ...
    candidates: Optional[List[LogprobsResultCandidate]] = Field(
        default=None, description="""Sorted by log probability in descending order."""
    )
...
class SafetyRating(_common.BaseModel):
    ...
    probability: Optional[HarmProbability] = Field(
        default=None, description="""Output only. Harm probability levels in the content."""
    )
    ...
    severity: Optional[HarmSeverity] = Field(
        default=None, description="""Output only. Harm severity levels in the content."""
    )
...
class Candidate(_common.BaseModel):
    ...
    avg_logprobs: Optional[float] = Field(
        default=None, description="""Output only. Average log probability score of the candidate."""
    )
...
class GenerateContentResponsePromptFeedback(_common.BaseModel):
    ...
    block_reason_message: Optional[str] = Field(
        default=None, description="""Output only. A readable block reason message."""
    )
    safety_ratings: Optional[List[SafetyRating]] = Field(
...
class GenerateContentResponseUsageMetadata(_common.BaseModel):
    ...
    total_token_count: Optional[int] = Field(
        default=None, description="""Total token count for prompt and response candidates."""
    )
...
class GenerateContentResponse(_common.BaseModel):
    ...
    def _from_response(
        ...
        response_schema = _common.get_value_by_path(kwargs, ["config", "response_schema"])
        if (
            inspect.isclass(response_schema)
            and not (isinstance(response_schema, _GenericAlias))  # Needed for Python 3.9 and 3.10
            ...
            try:
                ...
                pass
        elif isinstance(response_schema, _GenericAlias) or isinstance(response_schema, type):
...
class Image(_common.BaseModel):
    ...
    def from_file(cls, *, location: str) -> "Image":
        ...
        if parsed_url.scheme == "https" and parsed_url.netloc == "storage.googleapis.com":
...
JOB_STATES_SUCCEEDED_VERTEX = ["JOB_STATE_SUCCEEDED"]

JOB_STATES_SUCCEEDED_MLDEV = ["ACTIVE"]
...
JOB_STATES_ENDED_MLDEV = ["ACTIVE", "FAILED"]
...
class ControlReferenceConfig(_common.BaseModel):
    ...
    control_type: Optional[ControlReferenceType] = Field(
        default=None, description="""The type of control reference image to use."""
    )
...
class SubjectReferenceConfig(_common.BaseModel):
    ...
    subject_type: Optional[SubjectReferenceType] = Field(
        default=None, description="""The subject type of a subject reference image."""
    )
...
class _ReferenceImageAPI(_common.BaseModel):
    ...
    reference_image: Optional[Image] = Field(
        default=None, description="""The reference image for the editing operation."""
    )
    reference_id: Optional[int] = Field(
        default=None, description="""The id of the reference image."""
    )
    reference_type: Optional[str] = Field(
        default=None, description="""The type of the reference image. Only set by the SDK."""
    )
    mask_image_config: Optional[MaskReferenceConfig] = Field(
        default=None, description="""Configuration for the mask reference image."""
    )
    control_image_config: Optional[ControlReferenceConfig] = Field(
        default=None, description="""Configuration for the control reference image."""
    )
    style_image_config: Optional[StyleReferenceConfig] = Field(
        default=None, description="""Configuration for the style reference image."""
    )
    subject_image_config: Optional[SubjectReferenceConfig] = Field(
        default=None, description="""Configuration for the subject reference image."""
    )
...
class EditImageConfig(_common.BaseModel):
    ...
    edit_mode: Optional[EditMode] = Field(
        default=None, description="""Describes the editing mode for the request."""
    )
...
class _EditImageParameters(_common.BaseModel):
    ...
    prompt: Optional[str] = Field(
        default=None, description="""A text description of the edit to apply to the image."""
    )
...
class _UpscaleImageAPIConfig(_common.BaseModel):
    ...
    output_mime_type: Optional[str] = Field(
        default=None, description="""The image format that the output should be saved as."""
    )
    output_compression_quality: Optional[int] = Field(
        default=None,
...
class _UpscaleImageAPIParameters(_common.BaseModel):
    ...
    model: Optional[str] = Field(default=None, description="""The model to use.""")
    image: Optional[Image] = Field(default=None, description="""The input image to upscale.""")
    upscale_factor: Optional[str] = Field(
        default=None, description="""The factor to upscale the image (x2 or x4)."""
    )
...
class Endpoint(_common.BaseModel):
    ...
    name: Optional[str] = Field(default=None, description="""Resource name of the endpoint.""")
    deployed_model_id: Optional[str] = Field(
        default=None, description="""ID of the model that's deployed to the endpoint."""
    )
...
class TunedModelInfo(_common.BaseModel):
    ...
    base_model: Optional[str] = Field(
        default=None, description="""ID of the base model that you want to tune."""
    )
    create_time: Optional[datetime.datetime] = Field(
        default=None, description="""Date and time when the base model was created."""
    )
    update_time: Optional[datetime.datetime] = Field(
        default=None, description="""Date and time when the base model was last updated."""
    )
...
class Model(_common.BaseModel):
    ...
    name: Optional[str] = Field(default=None, description="""Resource name of the model.""")
    display_name: Optional[str] = Field(default=None, description="""Display name of the model.""")
    ...
    labels: Optional[Dict[str, str]] = Field(
        default=None, description="""Labels with user-defined metadata to organize your models."""
    )
    tuned_model_info: Optional[TunedModelInfo] = Field(
        default=None, description="""Information about the tuned model from the base model."""
    )
    ...
    supported_actions: Optional[List[str]] = Field(
        default=None, description="""List of actions that are supported by the model."""
    )
...
class ListModelsConfig(_common.BaseModel):
    ...
    query_base: Optional[bool] = Field(
        default=None, description="""Set true to list base models, false to list tuned models."""
    )
...
class GenerationConfig(_common.BaseModel):
    ...
    candidate_count: Optional[int] = Field(
        default=None, description="""Optional. Number of candidates to generate."""
    )
    frequency_penalty: Optional[float] = Field(
        default=None, description="""Optional. Frequency penalties."""
    )
    logprobs: Optional[int] = Field(default=None, description="""Optional. Logit probabilities.""")
    max_output_tokens: Optional[int] = Field(
        default=None,
    ...
    response_logprobs: Optional[bool] = Field(
        default=None, description="""Optional. If true, export the logprobs results in response."""
    )
    response_mime_type: Optional[str] = Field(
        default=None,
    ...
    temperature: Optional[float] = Field(
        default=None, description="""Optional. Controls the randomness of predictions."""
    )
    top_k: Optional[float] = Field(
        default=None, description="""Optional. If specified, top-k sampling will be used."""
    )
    top_p: Optional[float] = Field(
        default=None, description="""Optional. If specified, nucleus sampling will be used."""
    )
...
class _CountTokensParameters(_common.BaseModel):
    ...
    contents: Optional[ContentListUnion] = Field(default=None, description="""Input content.""")
...
_ComputeTokensParametersOrDict = Union[_ComputeTokensParameters, _ComputeTokensParametersDict]
...
class GenerateVideosConfig(_common.BaseModel):
    ...
    output_gcs_uri: Optional[str] = Field(
        default=None, description="""The gcs bucket where to save the generated videos."""
    )
    fps: Optional[int] = Field(
        default=None, description="""Frames per second for video generation."""
    )
    duration_seconds: Optional[int] = Field(
        default=None, description="""Duration of the clip for video generation in seconds."""
    )
    seed: Optional[int] = Field(
        default=None,
...
_GenerateVideosParametersOrDict = Union[_GenerateVideosParameters, _GenerateVideosParametersDict]
...
class Video(_common.BaseModel):
    ...
    def show(self):
        ...
        if IPython_display:
            return IPython_display.Video(data=self.video_bytes, mimetype=self.mime_type, embed=True)
...
class GenerateVideosResponse(_common.BaseModel):
    ...
    rai_media_filtered_count: Optional[int] = Field(
        default=None, description="""Returns if any videos were filtered due to RAI policies."""
    )
...
class GenerateVideosOperation(_common.BaseModel):
    ...
    response: Optional[Dict[str, Any]] = Field(
        default=None, description="""The normal response of the operation in case of success."""
    )
...
GenerateVideosOperationOrDict = Union[GenerateVideosOperation, GenerateVideosOperationDict]
...
_GetTuningJobParametersOrDict = Union[_GetTuningJobParameters, _GetTuningJobParametersDict]
...
SupervisedHyperParametersOrDict = Union[SupervisedHyperParameters, SupervisedHyperParametersDict]
...
class DatasetDistributionDistributionBucket(_common.BaseModel):
    ...
    count: Optional[int] = Field(
        default=None, description="""Output only. Number of values in the bucket."""
    )
...
class DatasetDistribution(_common.BaseModel):
    ...
    max: Optional[float] = Field(
        default=None, description="""Output only. The maximum of the population values."""
    )
    ...
    median: Optional[float] = Field(
        default=None, description="""Output only. The median of the values in the population."""
    )
    min: Optional[float] = Field(
        default=None, description="""Output only. The minimum of the population values."""
    )
    ...
    sum: Optional[float] = Field(
        default=None, description="""Output only. Sum of a given population of values."""
    )
...
class DatasetStats(_common.BaseModel):
    ...
    tuning_dataset_example_count: Optional[int] = Field(
        default=None, description="""Output only. Number of examples in the tuning dataset."""
    )
    tuning_step_count: Optional[int] = Field(
        default=None, description="""Output only. Number of tuning steps for this Tuning Job."""
    )
...
class DistillationDataStats(_common.BaseModel):
    ...
    training_dataset_stats: Optional[DatasetStats] = Field(
        default=None, description="""Output only. Statistics computed for the training dataset."""
    )
...
class SupervisedTuningDataStats(_common.BaseModel):
    ...
    user_input_token_distribution: Optional[SupervisedTuningDatasetDistribution] = Field(
        default=None,
        description="""Output only. Dataset distributions for the user input tokens.""",
    )
    user_message_per_example_distribution: Optional[SupervisedTuningDatasetDistribution] = Field(
        default=None,
        description="""Output only. Dataset distributions for the messages per example.""",
    )
    user_output_token_distribution: Optional[SupervisedTuningDatasetDistribution] = Field(
        default=None,
        description="""Output only. Dataset distributions for the user output tokens.""",
    )
...
SupervisedTuningDataStatsOrDict = Union[SupervisedTuningDataStats, SupervisedTuningDataStatsDict]
...
class DistillationSpec(_common.BaseModel):
    ...
    hyper_parameters: Optional[DistillationHyperParameters] = Field(
        default=None, description="""Optional. Hyperparameters for Distillation."""
    )
...
class TuningJob(_common.BaseModel):
    ...
    create_time: Optional[datetime.datetime] = Field(
        default=None, description="""Output only. Time when the TuningJob was created."""
    )
    ...
    description: Optional[str] = Field(
        default=None, description="""Optional. The description of the TuningJob."""
    )
    base_model: Optional[str] = Field(
        default=None,
    ...
    partner_model_tuning_spec: Optional[PartnerModelTuningSpec] = Field(
        default=None, description="""Tuning Spec for open sourced and third party Partner models."""
    )
    distillation_spec: Optional[DistillationSpec] = Field(
        default=None, description="""Tuning Spec for Distillation."""
    )
    experiment: Optional[str] = Field(
        default=None, description="""Output only. The Experiment associated with this TuningJob."""
    )
    labels: Optional[Dict[str, str]] = Field(
        default=None,
...
_ListTuningJobsParametersOrDict = Union[_ListTuningJobsParameters, _ListTuningJobsParametersDict]
...
class TuningExample(_common.BaseModel):
    ...
    output: Optional[str] = Field(default=None, description="""The expected model output.""")
...
class TuningDataset(_common.BaseModel):
    ...
    examples: Optional[List[TuningExample]] = Field(
        default=None, description="""Inline examples with simple input/output text."""
    )
...
TuningValidationDatasetOrDict = Union[TuningValidationDataset, TuningValidationDatasetDict]
...
class CreateTuningJobConfig(_common.BaseModel):
    ...
    learning_rate_multiplier: Optional[float] = Field(
        default=None, description="""Multiplier for adjusting the default learning rate."""
    )
    adapter_size: Optional[AdapterSize] = Field(
...
_CreateTuningJobParametersOrDict = Union[_CreateTuningJobParameters, _CreateTuningJobParametersDict]
...
class CreateCachedContentConfig(_common.BaseModel):
    ...
    expire_time: Optional[datetime.datetime] = Field(
        default=None, description="""Timestamp of when this resource is considered expired."""
    )
    display_name: Optional[str] = Field(
        default=None,
...
CreateCachedContentConfigOrDict = Union[CreateCachedContentConfig, CreateCachedContentConfigDict]
...
class _CreateCachedContentParameters(_common.BaseModel):
    ...
    model: Optional[str] = Field(
        default=None, description="""ID of the model to use. Example: gemini-1.5-flash"""
    )
...
class CachedContentUsageMetadata(_common.BaseModel):
    ...
    image_count: Optional[int] = Field(default=None, description="""Number of images.""")
    text_count: Optional[int] = Field(default=None, description="""Number of text characters.""")
    total_token_count: Optional[int] = Field(
        default=None, description="""Total number of tokens that the cached content consumes."""
    )
...
CachedContentUsageMetadataOrDict = Union[CachedContentUsageMetadata, CachedContentUsageMetadataDict]
...
class CachedContent(_common.BaseModel):
    ...
    name: Optional[str] = Field(
        default=None, description="""The server-generated resource name of the cached content."""
    )
    display_name: Optional[str] = Field(
        default=None,
        description="""The user-generated meaningful display name of the cached content.""",
    ...
    model: Optional[str] = Field(
        default=None, description="""The name of the publisher model to use for cached content."""
    )
    create_time: Optional[datetime.datetime] = Field(
        default=None, description="""Creation time of the cache entry."""
    )
    update_time: Optional[datetime.datetime] = Field(
        default=None, description="""When the cache entry was last updated in UTC time."""
    )
    expire_time: Optional[datetime.datetime] = Field(
        default=None, description="""Expiration time of the cached content."""
    )
    usage_metadata: Optional[CachedContentUsageMetadata] = Field(
        default=None, description="""Metadata on the usage of the cached content."""
    )
...
DeleteCachedContentConfigOrDict = Union[DeleteCachedContentConfig, DeleteCachedContentConfigDict]
...
UpdateCachedContentConfigOrDict = Union[UpdateCachedContentConfig, UpdateCachedContentConfigDict]
...
ListCachedContentsConfigOrDict = Union[ListCachedContentsConfig, ListCachedContentsConfigDict]
...
ListCachedContentsResponseOrDict = Union[ListCachedContentsResponse, ListCachedContentsResponseDict]
...
class ListFilesResponse(_common.BaseModel):
    ...
    files: Optional[List[File]] = Field(default=None, description="""The list of files.""")
...
class CreateFileResponse(_common.BaseModel):
    ...
    http_headers: Optional[Dict[str, str]] = Field(
        default=None, description="""Used to retain the HTTP headers in the request"""
    )
...
class _GetFileParameters(_common.BaseModel):
    ...
    name: Optional[str] = Field(
        default=None, description="""The name identifier for the file to retrieve."""
    )
...
class _DeleteFileParameters(_common.BaseModel):
    ...
    name: Optional[str] = Field(
        default=None, description="""The name identifier for the file to be deleted."""
    )
...
_CreateBatchJobParametersOrDict = Union[_CreateBatchJobParameters, _CreateBatchJobParametersDict]
...
class BatchJob(_common.BaseModel):
    ...
    create_time: Optional[datetime.datetime] = Field(
        default=None, description="""Output only. Time when the Job was created."""
    )
    start_time: Optional[datetime.datetime] = Field(
        default=None,
    ...
    update_time: Optional[datetime.datetime] = Field(
        default=None, description="""Output only. Time when the Job was most recently updated."""
    )
    model: Optional[str] = Field(
        default=None,
...
_CancelBatchJobParametersOrDict = Union[_CancelBatchJobParameters, _CancelBatchJobParametersDict]
...
_ListBatchJobsParametersOrDict = Union[_ListBatchJobsParameters, _ListBatchJobsParametersDict]
...
_DeleteBatchJobParametersOrDict = Union[_DeleteBatchJobParameters, _DeleteBatchJobParametersDict]
...
_GetOperationParametersOrDict = Union[_GetOperationParameters, _GetOperationParametersDict]
...
class TestTableItem(_common.BaseModel):
    name: Optional[str] = Field(
        default=None, description="""The name of the test. This is used to derive the replay id."""
    )
    parameters: Optional[Dict[str, Any]] = Field(
        default=None, description="""The parameters to the test. Use pydantic models."""
    )
    exception_if_mldev: Optional[str] = Field(
        default=None, description="""Expects an exception for MLDev matching the string."""
    )
    exception_if_vertex: Optional[str] = Field(
        default=None, description="""Expects an exception for Vertex matching the string."""
    )
...
class ReplayRequest(_common.BaseModel):
    ...
    body_segments: Optional[List[Dict[str, Any]]] = Field(default=None, description="""""")
...
class ReplayResponse(_common.BaseModel):
    ...
    headers: Optional[Dict[str, str]] = Field(default=None, description="""""")
    body_segments: Optional[List[Dict[str, Any]]] = Field(default=None, description="""""")
    sdk_response_segments: Optional[List[Dict[str, Any]]] = Field(default=None, description="""""")
...
class ReplayFile(_common.BaseModel):
    ...
    interactions: Optional[List[ReplayInteraction]] = Field(default=None, description="""""")
...
class MaskReferenceImage(_common.BaseModel):
    ...
    mask_image_config: Optional["MaskReferenceConfig"] = Field(default=None, description="""""")
...
class StyleReferenceImage(_common.BaseModel):
    ...
    style_image_config: Optional["StyleReferenceConfig"] = Field(default=None, description="""""")
...
LiveServerSetupCompleteOrDict = Union[LiveServerSetupComplete, LiveServerSetupCompleteDict]
...
LiveClientRealtimeInputOrDict = Union[LiveClientRealtimeInput, LiveClientRealtimeInputDict]
...
class LiveClientMessage(_common.BaseModel):
    ...
    tool_response: Optional[LiveClientToolResponse] = Field(
        default=None, description="""Response to a `ToolCallMessage` received from the server."""
    )
...
class LiveConnectConfig(_common.BaseModel):
    ...
    generation_config: Optional[GenerationConfig] = Field(
        default=None, description="""The generation configuration for the session."""
    )
