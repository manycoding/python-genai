...
def _GetTuningJobParameters_to_mldev(
    api_client: ApiClient, from_object: Union[dict, object], parent_object: Optional[dict] = None
) -> dict:
...
def _ListTuningJobsParameters_to_mldev(
    ...
    if getv(from_object, ["config"]) is not None:
        setv(
            to_object,
            ["config"],
            _ListTuningJobsConfig_to_mldev(api_client, getv(from_object, ["config"]), to_object),
        )
...
def _ListTuningJobsParameters_to_vertex(
    ...
    if getv(from_object, ["config"]) is not None:
        setv(
            to_object,
            ["config"],
            _ListTuningJobsConfig_to_vertex(api_client, getv(from_object, ["config"]), to_object),
        )
...
def _CreateTuningJobParameters_to_mldev(
    ...
    if getv(from_object, ["training_dataset"]) is not None:
        setv(
            ...
            _TuningDataset_to_mldev(api_client, getv(from_object, ["training_dataset"]), to_object),
        )
    ...
    if getv(from_object, ["config"]) is not None:
        setv(
            to_object,
            ["config"],
            _CreateTuningJobConfig_to_mldev(api_client, getv(from_object, ["config"]), to_object),
        )
...
def _CreateTuningJobParameters_to_vertex(
    ...
    if getv(from_object, ["config"]) is not None:
        setv(
            to_object,
            ["config"],
            _CreateTuningJobConfig_to_vertex(api_client, getv(from_object, ["config"]), to_object),
        )
...
def _TuningJob_from_mldev(
    ...
    if getv(from_object, ["_self"]) is not None:
        setv(
            to_object,
            ["tuned_model"],
            _TunedModel_from_mldev(api_client, getv(from_object, ["_self"]), to_object),
        )
...
def _TuningJob_from_vertex(
    ...
    if getv(from_object, ["tunedModel"]) is not None:
        setv(
            to_object,
            ["tuned_model"],
            _TunedModel_from_vertex(api_client, getv(from_object, ["tunedModel"]), to_object),
        )
    ...
    if getv(from_object, ["partnerModelTuningSpec"]) is not None:
        setv(
            to_object, ["partner_model_tuning_spec"], getv(from_object, ["partnerModelTuningSpec"])
        )
...
class Tunings(_api_module.BaseModule):
    def _get(
        self, *, name: str, config: Optional[types.GetTuningJobConfigOrDict] = None
    ) -> types.TuningJob:
        """Gets a TuningJob.
    ...
    def _tune(
        ...
        *,
        ...
        parameter_model = types._CreateTuningJobParameters(
            base_model=base_model, training_dataset=training_dataset, config=config
        )
    ...
    def list(
        ...
        return Pager("tuning_jobs", self._list, self._list(config=config), config)
    ...
    def get(
        ...
        if job.experiment and self._api_client.vertexai:
            _IpythonUtils.display_experiment_button(
                experiment=job.experiment, project=self._api_client.project
            )
        return job
        ...
        *,
        ...
        if self._api_client.vertexai:
            ...
            tuning_job = types.TuningJob(
                name=tuned_model_name, state=types.JobState.JOB_STATE_QUEUED
            )
        if tuning_job.name and self._api_client.vertexai:
            _IpythonUtils.display_model_tuning_button(tuning_job_resource=tuning_job.name)
        return tuning_job
...
class AsyncTunings(_api_module.BaseModule):
    ...
    async def list(
        ...
        return AsyncPager("tuning_jobs", self._list, await self._list(config=config), config)
