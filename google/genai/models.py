...
def _FunctionDeclaration_to_vertex(
    ...
    if getv(from_object, ["response"]) is not None:
        setv(
            to_object,
            ["response"],
            _Schema_to_vertex(api_client, getv(from_object, ["response"]), to_object),
        )
...
def _ControlReferenceConfig_to_mldev(
    ...
    if getv(from_object, ["enable_control_image_computation"]) is not None:
        raise ValueError(
            "enable_control_image_computation parameter is not supported in Gemini API."
        )
...
def _StyleReferenceConfig_to_mldev(
    ...
    if getv(from_object, ["style_description"]) is not None:
        raise ValueError("style_description parameter is not supported in Gemini API.")
...
def _ReferenceImageAPI_to_mldev(
    ...
    if getv(from_object, ["reference_image"]) is not None:
        raise ValueError("reference_image parameter is not supported in Gemini API.")
    ...
    if getv(from_object, ["mask_image_config"]) is not None:
        raise ValueError("mask_image_config parameter is not supported in Gemini API.")
    ...
    if getv(from_object, ["style_image_config"]) is not None:
        raise ValueError("style_image_config parameter is not supported in Gemini API.")
...
def _GenerateVideosConfig_to_mldev(
    ...
    if getv(from_object, ["duration_seconds"]) is not None:
        raise ValueError("duration_seconds parameter is not supported in Gemini API.")
    ...
    def generate_content(
        ...
        *,
        ...
        if _extra_utils.should_disable_afc(config):
            return self._generate_content(model=model, contents=contents, config=config)
