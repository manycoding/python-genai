...
_COUNT_TOKENS_PARAMS_WITH_SYSTEM_INSTRUCTION = copy.deepcopy(_COUNT_TOKENS_PARAMS)
...
_COUNT_TOKENS_PARAMS_WITH_TOOLS.config = {"tools": [{"google_search_retrieval": {}}]}

_COUNT_TOKENS_PARAMS_WITH_GENERATION_CONFIG = copy.deepcopy(_COUNT_TOKENS_PARAMS)
